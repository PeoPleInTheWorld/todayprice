...
export var Tabs = function (_Component) {
    ...
    function Tabs(props) {
        ...
        _this2.onPan = function () {
            ...
            return {
                ...
                onPanMove: function onPanMove(status) {
                    ...
                    setPxStyle(_this2.layout, offset, 'px', isVertical);
                    finalOffset = offset;
                },
                onPanEnd: function onPanEnd() {
                    ...
                    if (offsetIndex === _this2.state.currentTab) {
                        if (_this2.props.usePaged) {
                            setTransform(_this2.layout.style, _this2.getTransformByIndex(offsetIndex, _this2.isTabVertical()));
                        }
                    } else {
        ...
        _this2.state = _extends({}, _this2.state, new StateType(), { transform: _this2.getTransformByIndex(_this2.getTabIndex(props), _this2.isTabVertical(props.tabDirection)) });
        return _this2;
    }
    ...
    _createClass(Tabs, [{
        ...
        value: function renderContent() {
            ...
            var contentStyle = getTransformPropValue(transform);
            return React.createElement(
                ...
                tabs.map(function (tab, index) {
                    ...
                    return React.createElement(
                        TabPane,
                        { key: key, className: cls, active: currentTab === index, fixX: isTabVertical, fixY: !isTabVertical },
        ...
        value: function render() {
            ...
            var content = [React.createElement(
                ...
                Gesture,
                _extends({ key: '$content', direction: isTabVertical ? 'vertical' : 'horizontal', onSwipe: this.onSwipe }, onPan),
                this.renderContent()
            )];
            return React.createElement(
                'div',
